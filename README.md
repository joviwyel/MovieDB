...
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1: HTTP/1 thread                          | ![](path to image in img/)   | 48                         | 5.000145098490566                   | 4.780677283396226         | ??           |
| Case 2: HTTP/10 threads                        | ![](path to image in img/)   | 480                        | 547.5696141434049                   | 511.4818438287321         | ??           |
