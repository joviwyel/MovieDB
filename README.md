...
| Case 2: HTTP/10 threads                        | ![](images/scaled-case2-10.PNG)   | 94                        | 7.421240679              | 5.906030491                       | There are only 2 readers for 10 threads and 1 reader node reads 1 data entry at a time, so it has similar average query time as 1 thread. TS and TJ take slightly more time to reponse than in 1 thread because there are more threads. The TS and TJ are shorter than single instance due to the sharing of 10 threads among servers.  |
