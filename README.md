...
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1: HTTP/1 thread                          | ![](images/scaled-case1-1.PNG)  | 95                          | 3.481594854                       | 3.109576045                        | The average query time is longer than of single instance because there is a replication lag between master and slave so that the databases are consistent. The average TS and TJ time are shorter because of connection pooling.       |
